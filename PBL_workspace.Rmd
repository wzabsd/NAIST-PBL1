...
set.seed(2021)
library(mlr3verse)
lrn=lrn("classif.xgboost",booster="gbtree",tree_method="exact",nthread=16,nrounds=100,max_depth=8)
search_space = ps(
...
```{r}
learner=lrn("classif.xgboost",booster="gbtree",tree_method="exact",nthread=16,nrounds=700,max_depth=8,min_child_weight=1.95,gamma=0.38,subsample=0.93,colsample_bytree=0.788,alpha=0.365,eta=0.216)
```

```{r}
learner=lrn("classif.xgboost",booster="gbtree",tree_method="exact",nthread=16,nrounds=700,max_depth=8,min_child_weight=5.024391,gamma=0.1071455,subsample=0.9405026,colsample_bytree=0.7074007,alpha=8.432256,eta=0.1628942)
```
